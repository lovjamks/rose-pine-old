<p align="center">
    <img src="https://github.com/rose-pine-old/rose-pine-old-theme/raw/main/assets/icon.png" width="80" />
...
<p align="center">
    <a href="https://github.com/rose-pine-old/rose-pine-old-theme">
...
```lua
require('paq')({
  { 'rose-pine-old/neovim', as = 'rose-pine-old' }
})
```
...
```lua
require("lazy").setup({
  { 'rose-pine-old/neovim', name = 'rose-pine-old' }
})
```
...
require('packer').startup(function(use)
  use({ 'rose-pine-old/neovim', as = 'rose-pine-old' })
end)
```
...
require('rose-pine-old').setup({
	...
	-- https://github.com/rose-pine-old/neovim/wiki/Recipes
	highlight_groups = {
		ColorColumn = { bg = 'rose' },
...
vim.cmd('colorscheme rose-pine-old')
```
...
- [Adding new highlight groups](https://github.com/rose-pine-old/neovim/issues/6#issuecomment-962466323)
